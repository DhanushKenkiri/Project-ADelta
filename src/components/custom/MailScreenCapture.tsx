...
interface MailScreenCaptureProps {
  onCapture: (imageDataUrl: string) => void;
  onClose: () => void;
}

const MailScreenCapture: React.FC<MailScreenCaptureProps> = ({ onCapture, onClose }) => {
          ...
          {!previewUrl ? (
            <div className="flex flex-col items-center justify-center py-8">
              <p className="text-neutral-300 mb-4 text-center">
                Capture your screen to add as an attachment to your message
              </p>
              <button
...
export default MailScreenCapture; 